...
set(CPACK_PACKAGE_VERSION_MAJOR ${CHEW_VERSION_MAJOR})
set(CPACK_PACKAGE_VERSION_MINOR ${CHEW_VERSION_MINOR})
set(CPACK_PACKAGE_VERSION_PATCH ${CHEW_VERSION_PATCH})
set(CPACK_PACKAGE_VERSION "${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}.${CPACK_PACKAGE_VERSION_PATCH}")

if(NOT DEFINED CHEW_VERSION_OVERRIDE)
	if(EXISTS "${CMAKE_SOURCE_DIR}/.git")
		execute_process(COMMAND git describe --always --tags --dirty=-modified
			OUTPUT_VARIABLE CHEW_VERSION
			WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
			OUTPUT_STRIP_TRAILING_WHITESPACE)
	else()
		set(CHEW_VERSION "${CPACK_PACKAGE_VERSION}")
	endif()
else()
	set(CHEW_VERSION "${CHEW_VERSION_OVERRIDE}")
endif()

MESSAGE(STATUS "CHEW_VERSION: ${CHEW_VERSION}")
...
set(CPACK_BUNDLE_ICON "${CMAKE_SOURCE_DIR}/cmake/osxbundle/Chew.icns")
